...
void SqlList::deleteSqlTable(const QString &table)
{
    ...
    query.prepare("DELETE FROM newUser WHERE tab=:tab");
...
void SqlList::selectTableQueueLineInfo(const QString &table, int &id, bool &hex, QString &str, QString &sendStr,const  int &queue, int &time)
{
