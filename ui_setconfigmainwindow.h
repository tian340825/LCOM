/********************************************************************************
** Form generated from reading UI file 'setconfigmainwindow.ui'
**
...
#ifndef UI_SETCONFIGMAINWINDOW_H
#define UI_SETCONFIGMAINWINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *setConfigMainWindow)
    {
        if (setConfigMainWindow->objectName().isEmpty())
            setConfigMainWindow->setObjectName(QString::fromUtf8("setConfigMainWindow"));
        setConfigMainWindow->resize(825, 613);
        setConfigMainWindow->setMaximumSize(QSize(825, 705));
        centralwidget = new QWidget(setConfigMainWindow);
...
"color:rgb(253, 127, 151);"));
        ...
        pushButton->setStyleSheet(QString::fromUtf8("border-image: url(:/image/check/locm.png);"));
        ...
        setConfigMainWindow->setCentralWidget(centralwidget);

        retranslateUi(setConfigMainWindow);
        QObject::connect(closePushButton, SIGNAL(clicked()), setConfigMainWindow, SLOT(hide()));

        tabWidget->setCurrentIndex(1);


        QMetaObject::connectSlotsByName(setConfigMainWindow);
    } // setupUi

    void retranslateUi(QMainWindow *setConfigMainWindow)
    {
        setConfigMainWindow->setWindowTitle(QCoreApplication::translate("setConfigMainWindow", "MainWindow", nullptr));
        closePushButton->setText(QString());
        label_8->setText(QCoreApplication::translate("setConfigMainWindow", "   \350\256\276\347\275\256", nullptr));
        lineEdit->setText(QCoreApplication::translate("setConfigMainWindow", "\346\262\241\346\203\263\345\245\275\346\200\216\344\271\210\345\201\232", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("setConfigMainWindow", "\347\232\256\350\202\244", nullptr));
        pushButton->setText(QString());
        plainTextEdit->setPlainText(QCoreApplication::translate("setConfigMainWindow", "\346\254\242\350\277\216\344\275\277\347\224\250\n"
"LCOM\n"
...
"\345\275\223\345\211\215\347\211\210\346\234\2541.0 Debug", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("setConfigMainWindow", "\345\205\263\344\272\216", nullptr));
    } // retranslateUi

};

namespace Ui {
    class setConfigMainWindow: public Ui_setConfigMainWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SETCONFIGMAINWINDOW_H
